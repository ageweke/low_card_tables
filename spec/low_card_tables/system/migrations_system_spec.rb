...
describe "LowCardTables migration support" do
  ...
  context "with several dependent tables" do
    ...
    it "should not attempt to update any associated tables if a column is removed and told not to, but should still collapse IDs" do
      tn = @table_name
      ...
      migrate do
        remove_column tn, :donation_level, :low_card_update_referring_models => false
      end
    ...
    it "should not attempt to update any associated tables or collapse IDs if a column is removed and told not to" do
      tn = @table_name
